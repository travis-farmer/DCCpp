...
CurrentMonitor *SerialCommand::mMonitorP;

///////////////////////////////////////////////////////////////////////////////

void SerialCommand::init(volatile RegisterList *_mRegs, volatile RegisterList *_pRegs, CurrentMonitor *_mMonitor, CurrentMonitor *_mMonitorP){
  mRegs=_mRegs;
  pRegs=_pRegs;
  mMonitor=_mMonitor;
  mMonitorP=_mMonitorP;
 ...
 *
 *    returns: <a CURRENT>
 *    where CURRENT = 0-1024
 */
      INTERFACE.print("<a");
      INTERFACE.print(int(mMonitor->CalcTotalCurrent()));
      INTERFACE.print(">");
